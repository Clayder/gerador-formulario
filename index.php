...
//if($_SERVER['REQUEST_METHOD'] == 'POST'){
    //$dados = $_POST['dados'];
    $dados = '[{"inputTipo":"hidden", "tipo":"input","name":"xzx","value":"zxz","class":"xzxz","id":"xzx","complemento":"zxzx"},{"tipo":"select","name":"xzx","class":"zxz","id":"xzx","complemento":"zxzxz","option1":{"texto":"zx","value":"zxz"},"option2":{"texto":"xzx","value":"xzxzz"},"option3":{"texto":"xzx","value":"zxzxzxz"}},{"tipo":"radio","name":"xzx","class":"zxzx","id":"zxzx","complemento":"zxzxzxz","radio1":{"texto":"xzxz","value":"xzxzx"},"radio2":{"texto":"zzzzz","value":"zxz"},"radio3":{"texto":"xzxz","value":"xzxz"}}]';
...
echo "<pre>";
print_r($conteudoForm);
echo "</pre>";
echo "oi";
// Chama o controller e retorna o conteúdo do método
//Controller::callController($metodo, $class, $dados);
